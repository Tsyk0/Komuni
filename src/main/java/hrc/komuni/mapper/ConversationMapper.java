...
public interface ConversationMapper {
        ...
        @UpdateProvider(type = ConversationMapperProvider.class, method = "updateConversationAttriUserOrientedByConvId")
        int updateConversationAttriUserOrientedByConvId(Conversation conversation);
